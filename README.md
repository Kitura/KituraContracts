...
## Swift version
The 0.0.x releases were tested on macOS and Linux using the Swift 4.1 binary. Please note that this is the default version of Swift that is include in [Xcode 9.3](https://developer.apple.com/xcode/).
